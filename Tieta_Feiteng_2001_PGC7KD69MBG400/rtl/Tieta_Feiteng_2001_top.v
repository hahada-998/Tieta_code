...
module Tieta_Feiteng_2001_top(
    ...
    /* begin: JTAG 接口*/
    // 专用引脚暂不使用
    // output  o_PAL2_TDO                           /* synthesis LOC = "E8"*/ ,// from  JTAG_TDO / J12                               to  CPLD_S                                           default 1  // PAL2 TDO 信号
    ...
    // =============================================================================
    /* begin: I3C 接口*/
    output  reg o_PAL_CPU0_I3C_SPD_SEL              /* synthesis LOC = "D7"*/,// from  CPLD_S                                        to  CPU0_I3C_SPD_SEL / J14_G97V22312HR               default 1  // CPU0 I3C SPD 选择 信号
    output  reg o_PAL_CPU1_I3C_SPD_SEL              /* synthesis LOC = "B7"*/,// from  CPLD                                          to  CPU0/1_I2C_I3C_SW / U13                          default 1  // PAL CPU1 I3C SPD SEL 信号
    /* end: I3C 接口*/
...
wire                            cpu0_mcio0_cable_id0                                ; // CPU0 DIE1 C2C-L--J18
wire                            cpu0_mcio0_cable_id1                                ;
wire                            cpu0_mcio2_cable_id0                                ; // CPU0 DIE1-L--J20
wire                            cpu0_mcio2_cable_id1                                ;
wire                            cpu0_mcio3_cable_id0                                ; // CPU0 DIE1-H--J19
wire                            cpu0_mcio3_cable_id1                                ;

wire                            cpu1_mcio0_cable_id0                                ; // CPU1 DIE1 C2C-L--J21
wire                            cpu1_mcio0_cable_id1                                ;
wire                            cpu1_mcio2_cable_id0                                ; // CPU1 DIE1-L--J23
wire                            cpu1_mcio2_cable_id1                                ;
wire                            cpu1_mcio3_cable_id0                                ; // CPU1 DIE1-H--J24
...
wire [7:0]                      mcio0_slot_id                                       ; // CPU0 DIE1-C2C-L  --> J18
// wire [7:0]                      mcio1_slot_id                                       ;
wire [7:0]                      mcio2_slot_id                                       ; // CPU0 DIE1-L      --> J20 
wire [7:0]                      mcio3_slot_id                                       ; // CPU0 DIE1-H      --> J19
// wire [7:0]                      mcio10_slot_id                                      ;
// wire [7:0]                      mcio9_slot_id                                       ;
wire [7:0]                      mcio5_slot_id                                       ; // CPU1 DIE0 C2C-L  --> J21 
// wire [7:0]                      mcio6_slot_id                                       ;
wire [7:0]                      mcio7_slot_id                                       ; // CPU1 DIE1-L      --> J23
wire [7:0]                      mcio8_slot_id                                       ; // CPU1 DIE1-H      --> J24
...
// wire                            riser_prsnt_det_0                                   ; // 未使用
// wire                            riser_prsnt_det_1                                   ; // 未使用
// wire                            riser_prsnt_det_2                                   ; // 未使用
// wire                            riser_prsnt_det_3                                   ; // 未使用
// wire                            riser_prsnt_det_4                                   ; // 未使用
// wire                            riser_prsnt_det_5                                   ; // 未使用
// wire                            riser_prsnt_det_6                                   ; // 未使用
// wire                            riser_prsnt_det_7                                   ; // 未使用
...
wire                            rom_bmc_ma_rst                                      ; // MCPLD->SCPLD     BMC下发     addr 0x0007[1]  
wire                            rom_bmc_bk_rst                                      ; // MCPLD->SCPLD     BMC下发     addr 0x0007[0]  
wire [1:0]                      bmcctl_uart_sw                                      ; // MCPLD->SCPLD     BMC下发     addr 0x0016[7:6] 
...
wire                            db_i_pgd_usb_upd2_p1v1                              ; // SCPLD->MCPLD     BMC寄存                             1.1V USB eFuse过流故障信号
wire                            db_i_pgd_usb_upd1_p1v1                              ; // SCPLD->MCPLD     BMC寄存                             1.1V USB eFuse过流故障信号
wire                            db_i_riser4_pwr_pgd                                 ; // SCPLD->MCPLD     BMC寄存                             4号Riser供电就绪信号
wire                            db_i_pal_gpu4_efuse_oc                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
wire                            db_i_pal_gpu4_efuse_pg                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
wire                            db_i_pal_gpu3_efuse_oc                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
wire                            db_i_pal_gpu3_efuse_pg                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
wire                            db_i_pal_gpu2_efuse_oc                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
wire                            db_i_pal_gpu2_efuse_pg                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
wire                            db_i_pal_gpu1_efuse_oc                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
wire                            db_i_pal_gpu1_efuse_pg                              ; // SCPLD->MCPLD     BMC寄存                             1.3V GPU eFuse过流故障信号
...
wire                            rom_mux_bios_bmc_sel                                ; // MCPLD->SCPLD     BMC下发     addr 0x0007[6]
wire                            rom_mux_bios_bmc_en                                 ; // MCPLD->SCPLD     BMC下发     addr 0x0007[7]
wire                            test_bat_en                                         ; // MCPLD->SCPLD     BMC下发     addr 0x0008[7] 
wire                            rst_n                                               ;
...
wire [7:0]                      bios_read_rtc                                       ; // SCPLD            BIOS下发     addr 0x0C             RTC读控制
wire [7:0]                      bios_post_code                                      ; // SCPLD            BIOS下发     addr 0x0D             POST code
wire [7:0]                      bios_post_rate                                      ; // SCPLD            BIOS下发     addr 0x0E             POST rate 
wire [7:0]                      bios_post_phase                                     ; // SCPLD            BIOS下发     addr 0x0F             POST phase


/* 
wire                            ocp1_prsnt_n                                        ; // 不使用
wire                            ocp2_prsnt_n                                        ; // 不使用
wire [5:0]                      ocp1_pvti_ss_count                                  ; // 不使用
wire [5:0]                      ocp2_pvti_ss_count                                  ; // 不使用
wire [7:0]                      ocp1_pvti_byte3                                     ; // 不使用
wire [7:0]                      ocp1_pvti_byte2                                     ; // 不使用
wire [7:0]                      ocp1_pvti_byte1                                     ; // 不使用
wire [7:0]                      ocp1_pvti_byte0                                     ; // 不使用
wire [7:0]                      ocp2_pvti_byte3                                     ; // 不使用
wire [7:0]                      ocp2_pvti_byte2                                     ; // 不使用
wire [7:0]                      ocp2_pvti_byte1                                     ; // 不使用
wire [7:0]                      ocp2_pvti_byte0                                     ; // 不使用
*/

wire                            led_pwrbtn_gr_r                                     ; // MCPLD->SCPLD                                      电源灯控制
wire                            led_pwrbtn_amb_r                                    ; // MCPLD->SCPLD                                      电源灯控制
/*
wire                            pal_ocp1_ncsi_en                                    ; // 不使用
wire                            pal_ocp2_ncsi_en                                    ; // 不使用
*/
wire                            pal_ocp_ncsi_sw_en                                  ; // MCPLD->SCPLD                                       CP NCSI开关控制信号

wire                            db_i_pal_upd1_pewake_n                              ; // 未使用
wire                            db_i_pal_upd1_smib_n                                ; // 未使用
wire                            db_i_pal_upd2_pewake_n                              ; // 未使用
wire                            db_i_pal_upd2_smib_n                                ; // 未使用

wire                            db_i_cable_prsnt_n                                  ; // 未使用
wire                            db_i_lom_fan_on_aux                                 ; // 未使用
...
wire                            db_i_pal_riser1_prsnt_n                             ; // SCPLD->MCPLD   BMC寄存     addr 0x0080[1]      RISER1插槽存在信号
wire                            db_i_pal_riser2_prsnt_n                             ; // SCPLD->MCPLD   BMC寄存     addr 0x0080[0]      RISER2插槽存在信号
...
wire                            cpu_debug_sel                                       ; // MCPLD->SCPLD->BCPLD    UART仲裁选路
wire                            bmc_log_sel                                         ; // MCPLD->SCPLD->BCPLD    UART仲裁选路
...
// PWRGOOD DEBOUNCE
//--------------------------------------------------------------------------------------------------------------------------------------------------
PGM_DEBOUNCE_N #(.SIGCNT(19), .NBITS(2'b11), .ENABLE(1'b1)) db_inst_pwrgood (
    .clk			            (clk_50m),
    .rst_n		                (pon_reset_n),
    .timer_tick	                (1'b1),
    .din                        ({
                                i_PAL_PGD_USB_UPD2_P1V1         , //19
                                i_PAL_PGD_USB_UPD1_P1V1         , //18
                                i_PAL_RISER4_PWR_PGD            , //17
                                i_PAL_GPU4_EFUSE_OC             , //16
                                i_PAL_GPU4_EFUSE_PG             , //15
                                i_PAL_GPU3_EFUSE_OC             , //14
                                i_PAL_GPU3_EFUSE_PG             , //13
                                i_PAL_GPU2_EFUSE_OC             , //12
                                i_PAL_GPU2_EFUSE_PG             , //11
                                i_PAL_GPU1_EFUSE_OC             , //10 
                                i_PAL_GPU1_EFUSE_PG             , //09 
    ...
    .dout                       ({
                                db_i_pgd_usb_upd2_p1v1          , //19
                                db_i_pgd_usb_upd1_p1v1          , //18
                                db_i_riser4_pwr_pgd             , //17
                                db_i_pal_gpu4_efuse_oc          , //16
                                db_i_pal_gpu4_efuse_pg          , //15
                                db_i_pal_gpu3_efuse_oc          , //14
                                db_i_pal_gpu3_efuse_pg          , //13
                                db_i_pal_gpu2_efuse_oc          , //12
                                db_i_pal_gpu2_efuse_pg          , //11
                                db_i_pal_gpu1_efuse_oc          , //10
                                db_i_pal_gpu1_efuse_pg          , //09
...
PGM_DEBOUNCE_N #(.SIGCNT(8), .NBITS(2'b11), .ENABLE(1'b1)) db_intruder (
    .clk			            (clk_50m),
    .rst_n		                (pon_reset_n),
    .timer_tick	                (t512us_tick),
    .din                        ({
                                i_PAL_UPD1_PEWAKE_N             , //05 未使用
                                i_PAL_UPD1_SMIB_N               , //04 未使用
                                i_PAL_UPD2_PEWAKE_N             , //03 未使用 
                                i_PAL_UPD2_SMIB_N               , //02 未使用 


                                i_CPU0_VIN_SNS_ALERT            , //04 未使用 
                                i_CPU1_VIN_SNS_ALERT            , //03 未使用 
                                i_CABLE_PRSNT_N                 , //02 未使用
	                            i_PAL_LOM_FAN_ON_AUX_R            //01 未使用
	                            }),             
    .dout                       ({
                                db_i_pal_upd1_pewake_n          , //05 未使用
                                db_i_pal_upd1_smib_n            , //04 未使用
                                db_i_pal_upd2_pewake_n          , //03 未使用
                                db_i_pal_upd2_smib_n            , //02 未使用

                                db_i_cpu0_vin_sns_alert         , //04 未使用
                                db_i_cpu1_vin_sns_alert         , //03 未使用 
                                db_i_cable_prsnt_n              , //02 未使用
	                            db_i_lom_fan_on_aux               //01 未使用
	                            }) 
);
...
PGM_DEBOUNCE #(.SIGCNT(3), .NBITS(2'b10), .ENABLE(1'b1)) mcio_ab26 (
    .clk                        (clk_50m),
    .rst                        (~pon_reset_n),
    .timer_tick                 (1'b1),
    .din                        ({
...
SYNC_DATA_N #(.SIGCNT(4)) sync_cpu_data_low (
    .clk                        (clk_50m),
    .rst_n                      (pon_reset_n),          
    .din                        ({
...
assign scpld_to_mcpld_p2s_data[419]     = 1'b0 /*db_i_pal_ocp2_fan_foo    */;// 预留, 不使用 原db_i_pal_ocp2_fan_foo
assign scpld_to_mcpld_p2s_data[418]     = 1'b0 /*db_i_pal_lcd_card_in*/  ; // 预留, 不使用 原db_i_pal_lcd_card_in
...
// assign scpld_to_mcpld_p2s_data[376]     = pfr_pe_wake_n                  ; // 预留, 不使用 原pfr_pe_wake_n
...
assign scpld_to_mcpld_p2s_data[190]     = 1'b0 /*db_riser_prsnt_det_2   */; // 预留, 不使用 原db_riser_prsnt_det_2
assign scpld_to_mcpld_p2s_data[189]     = 1'b0 /*db_riser_prsnt_det_3   */; // 预留, 不使用 原db_riser_prsnt_det_3
assign scpld_to_mcpld_p2s_data[188]     = 1'b0 /*db_riser_prsnt_det_0   */; // 预留, 不使用 原db_riser_prsnt_det_0
assign scpld_to_mcpld_p2s_data[187]     = 1'b0 /*db_riser_prsnt_det_1   */; // 预留, 不使用 原db_riser_prsnt_det_1
assign scpld_to_mcpld_p2s_data[186]     = 1'b0 /*db_i_riser_prsnt_det_9 */; // 预留, 不使用 原db_riser_prsnt_det_9
assign scpld_to_mcpld_p2s_data[185]     = 1'b0 /*db_i_riser_prsnt_det_8 */; // 预留, 不使用 原db_riser_prsnt_det_8
assign scpld_to_mcpld_p2s_data[184]     = 1'b0 /*db_riser_prsnt_det_6   */; // 预留, 不使用 原db_riser_prsnt_det_6
assign scpld_to_mcpld_p2s_data[183]     = 1'b0 /*db_riser_prsnt_det_7   */; // 预留, 不使用 原db_riser_prsnt_det_7
assign scpld_to_mcpld_p2s_data[182]     = 1'b0 /*db_riser_prsnt_det_4   */; // 预留, 不使用 原db_riser_prsnt_det_4
assign scpld_to_mcpld_p2s_data[181]     = 1'b0 /*db_riser_prsnt_det_5   */; // 预留, 不使用 原db_riser_prsnt_det_5
assign scpld_to_mcpld_p2s_data[180]     = 1'b0 /*db_i_riser_prsnt_det_11*/; // 预留, 不使用 原db_i_riser_prsnt_det_11
assign scpld_to_mcpld_p2s_data[179]     = 1'b0 /*db_i_riser_prsnt_det_10*/; // 预留, 不使用 原db_i_riser_prsnt_det_10
...
assign scpld_to_mcpld_p2s_data[112]     = 1'b0 /*db_i_dimm_sns_alert*/   ; // 传入MCPLD, addr 0xA4[2] 
...
assign scpld_to_mcpld_p2s_data[56]      = db_i_pal_riser2_prsnt_n        ; // 传入MCPLD, addr 0x0080[1]
assign scpld_to_mcpld_p2s_data[55]      = db_i_pal_riser1_prsnt_n        ; // 传入MCPLD, addr 0x0080[0]

assign scpld_to_mcpld_p2s_data[54]      = riser2_emc_alert_n             ;
assign scpld_to_mcpld_p2s_data[53]      = riser1_emc_alert_n             ;
assign scpld_to_mcpld_p2s_data[52]      = db_pal_ext_rst_n               ; // 传入MCPLD, 外部复位信号
...
assign scpld_to_mcpld_p2s_data[21]      = db_i_pgd_usb_upd2_p1v1        /*cpu_nvme25_prsnt_n*/   ;//CPU0 D1
assign scpld_to_mcpld_p2s_data[20]      = db_i_pgd_usb_upd1_p1v1        /*cpu_nvme24_prsnt_n*/   ;//CPU0 D1

// 预留信号（原OCP 网卡存在信号）      
assign scpld_to_mcpld_p2s_data[19]      = db_i_riser4_pwr_pgd           /*ocp_prsent_b7_n*/      ; // 已使用
assign scpld_to_mcpld_p2s_data[18]      = db_i_pal_gpu4_efuse_oc        /*ocp_prsent_b6_n*/      ; // 已使用
assign scpld_to_mcpld_p2s_data[17]      = db_i_pal_gpu4_efuse_pg        /*ocp_prsent_b5_n*/      ; // 已使用
assign scpld_to_mcpld_p2s_data[16]      = db_i_pal_gpu3_efuse_oc        /*ocp_prsent_b4_n*/      ; // 已使用
assign scpld_to_mcpld_p2s_data[15]      = db_i_pal_gpu3_efuse_pg        /*ocp_prsent_b3_n*/      ; // 已使用
assign scpld_to_mcpld_p2s_data[14]      = db_i_pal_gpu2_efuse_oc        /*ocp_prsent_b2_n*/      ; // 已使用
assign scpld_to_mcpld_p2s_data[13]      = db_i_pal_gpu2_efuse_pg        /*ocp_prsent_b1_n*/      ; // 已使用
assign scpld_to_mcpld_p2s_data[12]      = db_i_pal_ocp_prsnt_n          /*ocp_prsent_b0_n*/      ; // 已使用

// Fan 安装状态信号
assign scpld_to_mcpld_p2s_data[11]      = db_i_pal_gpu1_efuse_oc        /*fan8_install_n*/        ; // 已使用
assign scpld_to_mcpld_p2s_data[10]      = db_i_pal_gpu1_efuse_pg        /*fan7_install_n*/        ; // 已使用
assign scpld_to_mcpld_p2s_data[9]       = db_i_pal_p12v_riser2_vin_fltb /*fan6_install_n*/        ; // 已使用
assign scpld_to_mcpld_p2s_data[8]       = db_i_pal_p12v_riser2_vin_pg   /*fan5_install_n*/        ; // 已使用
assign scpld_to_mcpld_p2s_data[7]       = db_i_pal_p12v_riser1_vin_fltb /*fan4_install_n*/        ; // 已使用
assign scpld_to_mcpld_p2s_data[6]       = db_i_pal_p12v_riser1_vin_pg   /*fan3_install_n*/        ; // 已使用
assign scpld_to_mcpld_p2s_data[5]       = db_i_pal_p12v_stby_efuse_fltb /*fan2_install_n*/        ; // 已使用
assign scpld_to_mcpld_p2s_data[4]       = db_i_pal_p12v_stby_efuse_pg   /*fan1_install_n*/        ; // 已使用
...
//M CPLD ---> S CPLD
assign cpu_debug_sel                  = mcpld_to_scpld_data_filter[350]      ;
assign bmc_log_sel                    = mcpld_to_scpld_data_filter[349]      ;
...
assign bmc_extrst_uid                 = mcpld_to_scpld_data_filter[344]     ; // 主CPLD UID_FUNCTIN 模块给出

// begin: 上下电调试使用
// assign pal_m2_0_sel_lv33_r            = mcpld_to_scpld_data_filter[343]     ; // 未使用
wire  mcpld_scpld_t1hz_clk;
assign mcpld_scpld_t1hz_clk           = mcpld_to_scpld_data_filter[343];
// end: 上下电调试使用
...
// assign pal_ocp2_ncsi_en               = mcpld_to_scpld_data_filter[217]  ; // 主CPLD 不使用
// assign pal_ocp1_ncsi_en               = mcpld_to_scpld_data_filter[216]  ; // 主CPLD 不使用
assign led_pwrbtn_gr_r                = mcpld_to_scpld_data_filter[217]  ;
assign led_pwrbtn_amb_r               = mcpld_to_scpld_data_filter[216]  ;
...
assign db_i_pal_pgd_p3v3		         = bmccpld_to_mbcpld_s2p_data[47]       ; // BCPLD->MCPLD 0xA5
assign db_i_pal_pgd_p1v8		         = bmccpld_to_mbcpld_s2p_data[46]       ; // BCPLD->MCPLD 0xA5
assign db_i_pal_pgd_p1v2	             = bmccpld_to_mbcpld_s2p_data[45]       ; // BCPLD->MCPLD 0xA5
assign db_i_pal_pgd_p1v1		         = bmccpld_to_mbcpld_s2p_data[44]       ; // BCPLD->MCPLD 0xA5
assign db_i_pal_pgd_p0v8		         = bmccpld_to_mbcpld_s2p_data[43]       ; // BCPLD->MCPLD 0xA5
assign i_pal_wdt_rst_n_r		         = bmccpld_to_mbcpld_s2p_data[42]       ; // BCPLD->MCPLD 0x0002[1];       BMC是否挂死使用
...
assign o_PAL_RISER2_SS_LD_N = 1'bz ;
...
不使用 */
//--------------------------------------------------------------------------------------------------------------------------------------------------
// end: riser1/riser2 sgpio scan chain
//--------------------------------------------------------------------------------------------------------------------------------------------------

//--------------------------------------------------------------------------------------------------------------------------------------------------
// begin: main board sgpio
//--------------------------------------------------------------------------------------------------------------------------------------------------
// CPU NVME 
...
assign sw[7]                = i_SW_8           ;
//--------------------------------------------------------------------------------------------------------------------------------------------------
// end: main board sgpio
//--------------------------------------------------------------------------------------------------------------------------------------------------



//--------------------------------------------------------------------------------------------------------------------------------------------------
// begin: I2C Update Start
//--------------------------------------------------------------------------------------------------------------------------------------------------
/*
wire wb_clk;
...
FanControl #(
    ...
    .i_1uSCE               (t1us_tick        ),
    .i_1000mSCE            (t1s_tick         ),                  
    .i_heartbeat           (i_pal_wdt_rst_n_r),// BCPLD->MCPLD 0x0002[1];       BMC是否挂死使用
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
// end: bmc active state
//--------------------------------------------------------------------------------------------------------------------------------------------------

//PE WAKE
// assign pfr_pe_wake_n = pal_pe_wake_n /*& i_PAL_RISER1_WAKE_N_R*/ ; // 不使用
...
// assign o_PAL_CPU0_I3C_SPD_SEL       = 1'b0; // 写死给bios
...
//TPM RST
assign o_PAL_RST_TCM_N_R            = tpm_rst ? 1'b0 : reached_sm_wait_powerok;
...
assign o_CPU0_RISER1_9548_RST_N_R   = rst_i2c_riser1_pca9548_n; // I2C15
assign o_CPU1_RISER2_9548_RST_N_R   = rst_i2c_riser2_pca9548_n; // I2C15
...
assign o_PAL_SPI_SELECT_R      = ~rom_mux_bios_bmc_sel ;// BIOS写死控制：1'b1; 由BMC控制: ~rom_mux_bios_bmc_sel 1'b0;
assign o_PAL_SPI_SWITCH_EN_R   = rom_mux_bios_bmc_en   ;// BIOS写死控制：1'b0; 由BMC控制: rom_mux_bios_bmc_en   1'b1;
...
assign o_PAL_M2_0_PERST_N_R        = pex_reset_n            ;//20240518 d00412 VB CHANGE
assign o_PAL_M2_1_PERST_N_R        = pex_reset_n            ;//20240518 d00412 VB CHANGE
...
I2C_SLAVE_REG inst_i2c_bios_reg (
    ...
    .wrdata                   (wrdata                       ),// in
    .test_pin                 (                             ),// output
    .o_usb_en                 (usb_en                       ),// output     BIOS下发       addr 0x00        USB使能控制 
    .o_bios_read_rtc          (bios_read_rtc[7:0]           ),// output     BIOS下发       addr 0x0C        RTC读控制
    .o_bios_post_80           (bios_post_code               ),// output     BIOS下发       addr 0x0D        POST code
    .o_bios_post_84           (bios_post_rate               ),// output     BIOS下发       addr 0x0E        POST rate 
    .o_bios_post_85           (bios_post_phase              ),// output     BIOS下发       addr 0x0F        POST phase
    .o_mb_cb_prsnt            (o_mb_cb_prsnt_bios           ),// output     BIOS下发       addr 0x2A,0x2C   CPU0/CPU1 CB存在情况，bit[15:8] CPU1 CB，bit[7:0] CPU0 CB
    .reg1_special_confi       (8'h00                        ),// input      BIOS寄存       addr 0x29[7:0]
    .riser_ocp_m2_slot_number (riser_ocp_m2_slot_number     ),// input      BIOS寄存       addr 0x32[2:0],0x31[7:0],0x30[7:0]
    .nvme_slot_number         (nvme_slot_number             ),// input      BIOS寄存       addr 0x37[6:0],0x36[7:0],0x35[7:0],0x34[7:0],0x33[7:0],0x32[7:3]
    ...
    .i_i2c_ram_64             (mcio0_slot_id                ),// CPU0 DIE1-C2C-L  --> J18
    // .i_i2c_ram_65             (mcio1_slot_id                ),//CPU0 DIE2-H J17
    .i_i2c_ram_66             (mcio2_slot_id                ),//CPU0 DIE1-L J20
    .i_i2c_ram_67             (mcio3_slot_id                ),//CPU0 DIE1-H J19
    ...
    .i_i2c_ram_6C             (mcio5_slot_id                ),//CPU1 DIE0 C2C-L J21 
    // .i_i2c_ram_6D             (mcio6_slot_id                ),//CPU1 DIE2-H J22
    .i_i2c_ram_6E             (mcio7_slot_id                ),//CPU1 DIE1-L J23
    .i_i2c_ram_6F             (mcio8_slot_id                ),//CPU1 DIE3-H J24

    // begin: RISER在位信息, 由BMC读取各单板board ID后判断单板是否在位
    ...
    // end: RISER在位信息, 由BMC读取各单板board ID后判断单板是否在位

    // begin: 背板在位信息, 由主板CPLD读取背板单板ID后判断单板是否在位
    .i_i2c_ram_75             (i2c_ram_1055                 ),//BP
    .i_i2c_ram_76             (i2c_ram_1056                 ),//BP
    .i_i2c_ram_77             (i2c_ram_1057                 ),//BP
    .i_i2c_ram_78             (i2c_ram_1058                 ),//BP
    // end: 背板在位信息, 由主板CPLD读取背板单板ID后判断单板是否在位

    // begin: PCIE 动态带宽分配使用
    .pal_mcio11_cable_id1     (1'b1 /*mb_cb1_cable_id[3]*/  ),//CPU0 DIE0-H--J1
    .pal_mcio11_cable_id0     (1'b1 /*mb_cb1_cable_id[2]*/  ),
    .pal_mcio12_cable_id1     (1'b1 /*mb_cb1_cable_id[1]*/  ),//CPU0 DIE0-L--J1
    .pal_mcio12_cable_id0     (1'b1 /*mb_cb1_cable_id[0]*/  ),
    .pal_mcio15_cable_id1     (1'b1 /*mb_cb2_cable_id[3]*/  ),//CPU1 DIE0-H--J39
    .pal_mcio15_cable_id0     (1'b1 /*mb_cb2_cable_id[2]*/  ),
    .pal_mcio16_cable_id1     (1'b1 /*mb_cb2_cable_id[1]*/  ),//CPU1 DIE0-L--J39
    .pal_mcio16_cable_id0     (1'b1 /*mb_cb2_cable_id[0]*/  ),

    .cpu0_mcio0_cable_id0     (cpu0_mcio0_cable_id0         ),//CPU0 DIE1 C2C-L--J18
    .cpu0_mcio0_cable_id1     (cpu0_mcio0_cable_id1         ),

    .cpu0_mcio2_cable_id0     (cpu0_mcio2_cable_id0         ),//CPU0 DIE1-L--J20
    .cpu0_mcio2_cable_id1     (cpu0_mcio2_cable_id1         ),
    .cpu0_mcio3_cable_id0     (cpu0_mcio3_cable_id0         ),//CPU0 DIE1-H--J19
    .cpu0_mcio3_cable_id1     (cpu0_mcio3_cable_id1         ),

    .cpu1_mcio0_cable_id0     (cpu1_mcio0_cable_id0         ),//CPU1 DIE1 C2C-L--J21
    .cpu1_mcio0_cable_id1     (cpu1_mcio0_cable_id1         ),

    .cpu1_mcio2_cable_id0     (cpu1_mcio2_cable_id0         ),//CPU1 DIE1-L--J23
    .cpu1_mcio2_cable_id1     (cpu1_mcio2_cable_id1         ),
    .cpu1_mcio3_cable_id0     (cpu1_mcio3_cable_id0         ),//CPU1 DIE1-H--J24
    ...
    // .bmc_read_flag            (1'b0                         ),//in 0x11[0], 仅测试使用
...
bmc_cpld_i2c_ram #(
    ...
    .i_1ms_clk                     (t1ms_tick                ),	          
    .i_rst_i2c_n                   (1'b1                     ),
    .i_scl                         (i_BMC_I2C3_PAL_S_SCL1_R  ), 
    .io_sda                        (io_BMC_I2C3_PAL_S_SDA1_R ),
...
wire[15:0]w_mb_to_bp_mcio2_data; // CPU0 DIE1-L     J20
wire[15:0]w_mb_to_bp_mcio3_data; // CPU0 DIE1-H     J19
// wire[15:0]w_mb_to_bp_mcio4_data;
wire[15:0]w_mb_to_bp_mcio5_data; // CPU1 DIE1 C2C-L J21
// wire[15:0]w_mb_to_bp_mcio6_data;
wire[15:0]w_mb_to_bp_mcio7_data; // CPU1 DIE1-L     J23
wire[15:0]w_mb_to_bp_mcio8_data; // CPU1 DIE1-H     J24
// wire[15:0]w_mb_to_bp_mcio9_data;
// wire[15:0]w_mb_to_bp_mcio10_data;
// wire[15:0]w_mb_to_bp_mcio11_data;

wire[15:0]w_bp_to_mb_mcio0_data; // CPU0 DIE1-C2C-L J18
wire[15:0]w_bp_to_mb_mcio2_data; // CPU0 DIE1-L     J20
wire[15:0]w_bp_to_mb_mcio3_data; // CPU0 DIE1-H     J19
// wire[15:0]w_bp_to_mb_mcio4_data;
wire[15:0]w_bp_to_mb_mcio5_data; // CPU1 DIE1 C2C-L J21
// wire[15:0]w_bp_to_mb_mcio6_data;
wire[15:0]w_bp_to_mb_mcio7_data; // CPU1 DIE1-L     J23
wire[15:0]w_bp_to_mb_mcio8_data; // CPU1 DIE1-H     J24
...
assign mcio0_slot_id  = w_bp_to_mb_mcio0_data[7:0]; // CPU0 DIE1-C2C-L J18
// assign mcio1_slot_id  = w_bp_to_mb_mcio1_data[7:0];
assign mcio2_slot_id  = w_bp_to_mb_mcio2_data[7:0]; // CPU0 DIE1-L     J20
assign mcio3_slot_id  = w_bp_to_mb_mcio3_data[7:0]; // CPU0 DIE1-H     J19
// assign mcio4_slot_id  = w_bp_to_mb_mcio4_data[7:0];
assign mcio5_slot_id  = w_bp_to_mb_mcio5_data[7:0]; // CPU1 DIE0 C2C-L J21 
// assign mcio6_slot_id  = w_bp_to_mb_mcio6_data[7:0];
assign mcio7_slot_id  = w_bp_to_mb_mcio7_data[7:0]; // CPU1 DIE1-L     J23
assign mcio8_slot_id  = w_bp_to_mb_mcio8_data[7:0]; // CPU1 DIE1-H     J24
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
//VMD ON_OFF FOR CPU0 DIE1-C2C-L  --> J18    MCIO0
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
//VMD ON_OFF FOR CPU0 DIE1-L  --> J20    MCIO2 
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
//VMD ON_OFF FOR CPU0 DIE1-H  --> J19    MCIO3
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
//VMD ON_OFF FOR CPU1 DIE0 C2C-L  --> J21    MCIO0  
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
//VMD ON_OFF FOR CPU1 DIE1-L   --> J23    MCIO2
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
//VMD ON_OFF FOR CPU1 DIE1-H   --> J24    MCIO3
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
//CPU1 I2C SDA, 保持高阻态
assign io_CPU1_D0_I2C1_PE_STRAP_SDA = 1'bz;
