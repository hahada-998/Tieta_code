...
module bmc_cpld_i2c_ram #( 
    ...
    input               i_fan1_p12v_gok ,         //addr 0x0020[3]
    input               i_fan2_prsnt_n  ,         //addr 0x0020[4]
    input               i_fan2_p12v_gok ,         //addr 0x0020[5]
    input               i_fan3_prsnt_n  ,         //addr 0x0020[6]
    input               i_fan3_p12v_gok ,         //addr 0x0020[7]

    output              o_fan3_p12v_en  ,         //addr 0x0021[3]
    output              o_fan2_p12v_en  ,         //addr 0x0021[2]
    output              o_fan1_p12v_en  ,         //addr 0x0021[1]
    output              o_fan0_p12v_en  ,         //addr 0x0021[0]

    output      [7:0]   o_pwm_bmc_fan0  ,         //addr 0x0022
    output      [7:0]   o_pwm_bmc_fan1  ,         //addr 0x0023
    output      [7:0]   o_pwm_bmc_fan2  ,         //addr 0x0024
    output      [7:0]   o_pwm_bmc_fan3  ,         //addr 0x0025

    input       [7:0]   i_fan0_type     ,         //addr 0x0026
    input       [7:0]   i_fan1_type     ,         //addr 0x0027
    input       [7:0]   i_fan2_type     ,         //addr 0x0028
    input       [7:0]   i_fan3_type     ,         //addr 0x0029

    output      [7:0]   o_bmc_ctr_fan_led_status, //addr 0x002A[3:0]
    ...
    input        [1:0]  bp_prsnt,                 //addr 0x0071 [1:0]
    input        [1:0]  bp_cpu_1p2p,              //addr 0x0071 [3:2]
...
reg [7:0] r_reg_0031;
reg [7:0] r_reg_0032;
// r_reg_0033~r_reg_003F暂不使用，预留给风扇相关寄存器
...
/* r_reg_0040~r_reg_0047 预留风扇转速寄存器
